...
class CommunityCommentsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CommunityComments') ? [] : ['className' => 'App\Model\Table\CommunityCommentsTable'];
        $this->CommunityComments = TableRegistry::get('CommunityComments', $config);
    }
